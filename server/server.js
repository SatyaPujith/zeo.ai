...
const allowedOrigins = [
  ...
  'http://localhost:8082',  // Vite dev server (alternative port 2)
  'http://127.0.0.1:8080',  // Alternative localhost
  'http://127.0.0.1:8081',  // Alternative localhost (alternative port)
  'http://127.0.0.1:8082',  // Alternative localhost (alternative port 2)
...
app.get('/api/tavus/health', optionalAuth, async (req, res) => {
  try {
...
// Create conversation
app.post('/api/tavus/conversation', optionalAuth, async (req, res) => {
  try {
